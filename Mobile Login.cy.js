    ...
    before(() => {
      ...
      it('login', () => {
         ...
         it('should display an error message with invalid credentials', () => {
              ...
              //Click log in button
              cy.get('.col-auto > .q-icon').click()
              cy.get('.q-px-md > .q-btn--outline').click()  
            ...
            it('Create new account', () => {
              ...
              cy.wait(2000)
              cy.get('[data-cy="register-input"]').clear().type("Testcypress2@gmail.com"); //Email
              cy.get('.q-pa-none > .q-btn').click(); //Continue btn

              cy.get('[data-cy="register-username"]').type('Cypress2');
              cy.get('.q-pa-none.q-py-md > :nth-child(4)').click() 
              cy.get(':nth-child(3) > .relative-position > .full-width').type('New York, NY, USA')
